...
const SvgRdtResultPositive = (
  ...
  return (
    ...
    >
      <path
        d="M20 38a2 2 0 1 1-4 0 2 2 0 0 1 4 0ZM18 31a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18 8a4 4 0 0 0-4 4v13a4 4 0 0 0 8 0V12a4 4 0 0 0-4-4Zm2 6v-2a2 2 0 1 0-4 0v2h4Zm-4 2v5h4v-5h-4Zm0 9v-2h4v2a2 2 0 1 1-4 0Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
