...
const SvgNurse = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      width="1.5em"
      height="1.5em"
      ...
      {...props}
    >
      <path d="M27 13v-2h-2V9h-2v2h-2v2h2v2h2v-2h2Z" fill={props.color} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill={props.color}
      />
      <path d="M34 34h2v2h-2v2h-2v-2h-2v-2h2v-2h2v2Z" fill={props.color} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
