...
const SvgAsthmaInhaler = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M42 31a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM38 33a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM38 37a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM43 34a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM43 38a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
        fill={props.color}
      />
    </svg>
  );
