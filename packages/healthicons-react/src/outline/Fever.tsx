...
const SvgFever = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.236 20.43c2.024.751 4.248.26 6.16-1.555.334.99-.55 3.071-2.732 3.393-2.182.322-3.575-.927-3.428-1.838Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
      ...
      />
      <path
        d="M33.325 20.43c-2.024.751-4.248.26-6.16-1.555-.333.99.55 3.071 2.733 3.393 2.181.322 3.574-.927 3.427-1.838Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
      ...
      <path
        ...
        fill={props.color}
      />
      <path d="M17 28a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" fill={props.color} />
    </svg>
  );
};
