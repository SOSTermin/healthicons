...
const SvgSodiumFree = (
  ...
  return (
    ...
    >
      <path
        d="M27 11a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM29 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM31 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM23 24a1 1 0 1 0-2 0v9a1 1 0 1 0 2 0v-9ZM26 23a1 1 0 0 1 1 1v9a1 1 0 1 1-2 0v-9a1 1 0 0 1 1-1Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
