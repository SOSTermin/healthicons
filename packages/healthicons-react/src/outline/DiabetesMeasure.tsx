...
const SvgDiabetesMeasure = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M16.984 27.986a1 1 0 0 0 .001 2l4-.003a1 1 0 1 0-.001-2l-4 .003ZM25.985 28.979a1 1 0 0 1 .999-1.001l4-.003a1 1 0 1 1 .001 2l-4 .003a1 1 0 0 1-1-1ZM23.982 40.204a2 2 0 1 0-.003-4 2 2 0 0 0 .003 4Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
