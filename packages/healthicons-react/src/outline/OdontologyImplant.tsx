...
const SvgOdontologyImplant = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M33.095 32.92 16.3 38.966l-.4-1.73 17.585-6.33c.008.177-.008.36-.05.544l-.34 1.47ZM17.013 40.835l15.547-5.597-.471 2.044-13.05 4.698a3 3 0 0 1-2.026-1.145ZM31.554 39.6 24.889 42h3.724a3 3 0 0 0 2.924-2.325l.017-.074Z"
        fill={props.color}
      />
    </svg>
  );
