...
const SvgCrying = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      width="1.5em"
      height="1.5em"
    ...
    >
      <path
        d="M31.424 38.177A15.93 15.93 0 0 1 24 40c-8.837 0-16-7.163-16-16S15.163 8 24 8s16 7.163 16 16c0 .167-.003.334-.008.5h2.001c.005-.166.007-.333.007-.5 0-9.941-8.059-18-18-18S6 14.059 6 24s8.059 18 18 18c3.025 0 5.876-.746 8.379-2.065l-.954-1.758Z"
        fill={props.color}
      />
      <path
      ...
      />
      <path
        d="M20.8 33.6c1.6-2.133 4.8-2.133 6.4 0a1 1 0 0 0 1.6-1.2c-2.4-3.2-7.2-3.2-9.6 0a1 1 0 0 0 1.6 1.2Z"
        fill={props.color}
      />
    </svg>
  );
