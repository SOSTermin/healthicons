...
const SvgSmokingCessation = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M38 19a1 1 0 1 0 0 2 4 4 0 0 1 4 4v3a1 1 0 1 0 2 0v-3a5.994 5.994 0 0 0-2.644-4.974A4.4 4.4 0 0 0 43 16.59V15a5 5 0 0 0-5-5 1 1 0 1 0 0 2 3 3 0 0 1 3 3v1.59A2.41 2.41 0 0 1 38.59 19H38ZM44 32a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0v-4Z"
        fill={props.color}
      />
    </svg>
  );
