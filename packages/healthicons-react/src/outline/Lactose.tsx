...
const SvgLactose = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M22 15a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM25 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM31 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM30 5a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM27 7a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM28 15a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"
        fill={props.color}
      />
    </svg>
  );
