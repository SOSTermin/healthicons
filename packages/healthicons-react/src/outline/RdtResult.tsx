  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14 12a4 4 0 0 1 8 0v13a4 4 0 0 1-8 0V12Zm6 0v2h-4v-2a2 2 0 1 1 4 0Zm-4 13v-9h4v9a2 2 0 1 1-4 0Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v36a2 2 0 0 1-2 2H12a2 2 0 0 1-2-2V6Zm2 0h12v36H12V6Z"
        fill={props.color}
      />
      <path
...
const ForwardRef = forwardRef(SvgRdtResult);
