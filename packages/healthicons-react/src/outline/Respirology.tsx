...
const SvgRespirology = (
  ...
  return (
    ...
    >
      <path
        d="M17.706 14.24c3.83-.003 3.783 4.837 3.758 7.323l-.003.525c0 .507.023 1.106.048 1.76.115 3.038.276 7.27-1.539 9.082-2.247 2.245-6.744 3.37-8.995 1.503-2.25-1.867 1.483-20.188 6.731-20.193ZM26.49 21.56c-.028-2.485-.084-7.325 3.747-7.329 5.247-.004 9.011 18.311 6.764 20.182-2.248 1.871-6.747.753-8.998-1.488-1.818-1.81-1.664-6.041-1.554-9.079.024-.654.046-1.253.045-1.761 0-.16-.002-.335-.004-.525Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
