...
const SvgTraumatism = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M28.548 15.367c2.725.611 4.542 1.92 5.708 3.392a8.547 8.547 0 0 1 1.438 2.695 7.585 7.585 0 0 1 .282 1.22c.026.198.02.174.016.15a.324.324 0 0 0-.003-.017l.003.017.001.01a2 2 0 0 1-3.984.359v-.002a3.59 3.59 0 0 0-.125-.52 4.548 4.548 0 0 0-.765-1.43c-.515-.65-1.432-1.446-3.119-1.892V42a2 2 0 0 1-3.993.166l-1-12A2.01 2.01 0 0 1 23 30h-.05a3.5 3.5 0 0 0 .222-4.76l-2.061-2.437 7.437-7.436ZM16.141 27.767a.988.988 0 0 1-.14.1V42a2 2 0 0 0 3.992.166l.933-11.192a3.497 3.497 0 0 1-3.098-1.213l-1.687-1.994Z"
        fill={props.color}
      />
      <path
