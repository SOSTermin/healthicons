...
const SvgBloodRhP = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M32 19a1 1 0 0 1 1-1h1v-1a1 1 0 1 1 2 0v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1h-1a1 1 0 0 1-1-1Z"
        fill={props.color}
      />
    </svg>
  );
