...
const SvgMeasles = (
  ...
  return (
    ...
    >
      <path
        d="M14.221 16.372a1 1 0 0 1 1.309-.22l4 2.5a1 1 0 0 1 0 1.696l-4 2.5a1 1 0 0 1-1.219-1.573c.982-.934 1.174-1.422 1.171-1.729-.002-.33-.225-.85-1.198-1.848a1 1 0 0 1-.063-1.326ZM32.47 16.152a1 1 0 0 1 1.246 1.546c-.973.998-1.196 1.518-1.198 1.848-.003.307.189.795 1.171 1.73a1 1 0 0 1-1.219 1.572l-4-2.5a1 1 0 0 1 0-1.696l4-2.5ZM33.258 31c-1.72-3.562-5.22-6-9.258-6-4.038 0-7.538 2.438-9.258 6-.469.97.316 2 1.394 2h15.728c1.078 0 1.863-1.03 1.394-2ZM26 12.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM38 27.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
