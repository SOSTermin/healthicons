...
const SvgSugarAlt = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m8 31.5-2.5-4 16-.5-4 5.5-4.5.5-5-1.5ZM5 22h2v2H5v-2ZM13 22h2v2h-2v-2ZM10 21.586 11.414 23 10 24.414 8.586 23 10 21.586ZM18 21.586 19.414 23 18 24.414 16.586 23 18 21.586ZM11 18h2v2h-2v-2ZM8 17.586 9.414 19 8 20.414 6.586 19 8 17.586ZM12 13.586 13.414 15 12 16.414 10.586 15 12 13.586ZM16 17.586 17.414 19 16 20.414 14.586 19 16 17.586Z"
        fill={props.color}
      />
    </svg>
  );
