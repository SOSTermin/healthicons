...
const SvgOldMan = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      width="1.5em"
      height="1.5em"
    ...
    >
      <path
        d="M22 13a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM35 25a3 3 0 0 0-3 3v.343a1 1 0 1 0 2 0V28a1 1 0 1 1 2 0v14.946a1 1 0 1 0 2 0V28a3 3 0 0 0-3-3ZM29.709 20.179 28 19.433l1.595.677.114.069ZM30.935 21.241a4.966 4.966 0 0 0-1.226-1.062L36 22.928 36 22.832v.002c.095 1.1-.755 2.067-1.899 2.16-1.134.09-2.132-.714-2.241-1.801v-.002a3.488 3.488 0 0 0-.13-.52 4.492 4.492 0 0 0-.795-1.43Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
