...
const SvgMilitaryWorker = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="m35 24 5-2.857V9h2v23l-7-3v-5ZM35.726 31.728 32.644 42H42v-5.5c0-2.004-2.663-3.642-6.274-4.772Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
      ...
      />
      <path
        d="M12.142 29.338a1 1 0 1 0-.895-1.788L7.552 29.4a1 1 0 0 0 .896 1.788l3.694-1.85Z"
        fill={props.color}
      />
    </svg>
  );
