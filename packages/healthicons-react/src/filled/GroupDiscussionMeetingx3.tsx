...
const SvgGroupDiscussionMeetingx3 = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M23 12.833A4.833 4.833 0 0 0 18.167 8h-3.169a4.998 4.998 0 0 0-.181 9.993L15 18v2s8-1.167 8-7.167ZM26 11.236A5.236 5.236 0 0 1 31.236 6H37a5 5 0 0 1 0 10h-2v3s-9-1.264-9-7.764ZM25 36.545C25 33.523 30.663 32 33.5 32c2.837 0 8.5 1.523 8.5 4.545V42H25v-5.455Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M24 35v-.455c0-.893.524-1.656 1.34-2.287l.141-.105c.697-.506 1.58-.923 2.524-1.25a9.496 9.496 0 0 0-2.968-.845 9.286 9.286 0 0 0-2.074 0 9.495 9.495 0 0 0-2.968.844c.943.328 1.827.745 2.523 1.25.048.035.095.07.141.106.817.63 1.34 1.394 1.34 2.287V35H24Z"
        fill={props.color}
      />
    </svg>
  );
