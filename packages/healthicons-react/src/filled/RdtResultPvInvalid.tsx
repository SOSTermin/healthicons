...
const SvgRdtResultPvInvalid = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M23.436 38.351a1 1 0 0 1-1.872 0l-1.5-4a1 1 0 1 1 1.872-.702l.564 1.503.564-1.503a1 1 0 1 1 1.872.702l-1.5 4ZM35 16a1 1 0 0 0 1-1v-2a1 1 0 0 0 0-2 1 1 0 0 0 0-2c-.726 0-1.276.325-1.611.79A2.116 2.116 0 0 0 34 11a1 1 0 1 0 0 2v2a1 1 0 0 0 1 1ZM13 23h-2a1 1 0 1 0 0 2h2v-2ZM15 23v2h7v-2h-7ZM24 25h2a1 1 0 1 0 0-2h-2v2Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
...
const ForwardRef = forwardRef(SvgRdtResultPvInvalid);
