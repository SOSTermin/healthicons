...
const SvgTac = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      width="1.5em"
      height="1.5em"
      ...
      {...props}
    >
      <path d="M24 25a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" fill={props.color} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
const ForwardRef = forwardRef(SvgTac);
