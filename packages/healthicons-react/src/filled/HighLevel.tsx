...
const SvgHighLevel = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M21.519 29.91a1.614 1.614 0 0 0-.973.597l-1.638 2.43c-.183 1.213-.053 1.696.665 2.48l2.633 1.284c.364.15.77.16 1.141.032l12.716-5.872c1.891-.657 1.385-2.617-.582-2.24L21.52 29.91Z"
        fill={props.color}
      />
    </svg>
  );
