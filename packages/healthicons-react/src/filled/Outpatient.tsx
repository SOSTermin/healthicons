...
const SvgOutpatient = (
  ...
  return (
    ...
    >
      <path
        d="M21.935 10.723a4.001 4.001 0 1 1-7.86-1.494c1.525.926 2.854 1.448 4.239 1.638 1.176.16 2.34.074 3.62-.144ZM14.946 7.417a4.002 4.002 0 0 1 6.845 1.301c-1.262.225-2.251.298-3.206.167-1.08-.148-2.192-.568-3.64-1.468ZM14.5 15c-2.736 0-4.902 1.67-6.291 3.69C6.81 20.727 6 23.368 6 25.973c0 1.391.645 3.005 1.1 4.02A25.335 25.335 0 0 0 8 31.79V40a2 2 0 1 0 4 0V28.544c.292-2.408.978-4.59 1.763-6.374l.657 2.556a2 2 0 0 0 1.937 1.503H21.5a2 2 0 1 0 0-4h-3.592l-1.47-5.727A2 2 0 0 0 14.5 15ZM37 18a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
