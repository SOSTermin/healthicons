...
const SvgPpeGoggles = (
  ...
  return (
    ...
    >
      <path
        d="M11.5 26a1.5 1.5 0 0 1 1.5-1.5h22a1.5 1.5 0 0 1 1.5 1.5v3a4.5 4.5 0 0 1-8.805 1.315c-.43-1.412-1.76-2.815-3.695-2.815-1.935 0-3.264 1.403-3.695 2.815A4.5 4.5 0 0 1 11.5 29v-3Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
