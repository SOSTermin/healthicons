...
const SvgHelicopter = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M5 10a1 1 0 1 0 0 2h33.005a1 1 0 1 0 0-2H5ZM4.375 34.22a1 1 0 0 1 1.406.155c.22.276.783.6 1.758.88.924.265 2.037.44 3.135.554a38.511 38.511 0 0 0 4.083.192h.082l.01-.001H30.5a1 1 0 0 1 0 2H14.847l-.073.001-.271.001a40.498 40.498 0 0 1-4.034-.204c-1.152-.119-2.396-.31-3.481-.62-1.034-.297-2.133-.758-2.769-1.553a1 1 0 0 1 .156-1.406Z"
        fill={props.color}
      />
    </svg>
  );
