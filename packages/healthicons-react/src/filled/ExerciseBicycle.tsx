...
const SvgExerciseBicycle = (
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M7 41a1 1 0 0 1 1-1h5a1 1 0 1 1 0 2H8a1 1 0 0 1-1-1Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
      ...
      />
      <path
        d="M6 17.15a2.85 2.85 0 0 1 3.134-2.837l4.502.45a2.625 2.625 0 0 1-.26 5.237H8.85A2.85 2.85 0 0 1 6 17.15Z"
        fill={props.color}
      />
      <path
        fillRule="evenodd"
