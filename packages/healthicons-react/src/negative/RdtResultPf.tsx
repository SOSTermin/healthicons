...
const SvgRdtResultPf = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#rdt_result_pf_svg__a)" fill={props.color}>
        <path d="M40 24a2 2 0 1 0-4 0 2 2 0 0 0 4 0ZM32.5 25.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M11 27a3 3 0 1 1 0-6h15a3 3 0 1 1 0 6H11Zm0-4h2v2h-2a1 1 0 1 1 0-2Zm11 2h-7v-2h7v2Zm2 0h2a1 1 0 1 0 0-2h-2v2Z"
        />
      ...
      <defs>
        <clipPath id="rdt_result_pf_svg__a">
