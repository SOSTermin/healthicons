...
const SvgRdtResultMixedRectangular = (
  ...
  return (
    ...
    >
      <g
        clipPath="url(#rdt_result_mixed_rectangular_svg__a)"
        fill={props.color}
      >
