...
const SvgRdtResultPv = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#rdt_result_pv_svg__a)" fill={props.color}>
        <path d="M40 24a2 2 0 1 0-4 0 2 2 0 0 0 4 0ZM32.5 25.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M11 21a3 3 0 1 0 0 6h15a3 3 0 1 0 0-6H11Zm0 2h2v2h-2a1 1 0 1 1 0-2Zm7 0h-3v2h3v-2Zm2 2h6a1 1 0 1 0 0-2h-6v2Z"
        />
      ...
      <defs>
        <clipPath id="rdt_result_pv_svg__a">
