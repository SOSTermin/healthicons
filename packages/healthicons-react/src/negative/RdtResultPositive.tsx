...
const SvgRdtResultPositive = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#rdt_result_positive_svg__a)" fill={props.color}>
        <path d="M18 40a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM16.5 32.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M14 12a4 4 0 0 1 8 0v13a4 4 0 0 1-8 0V12Zm6 0v2h-4v-2a2 2 0 1 1 4 0Zm-4 9v-5h4v5h-4Zm0 2v2a2 2 0 1 0 4 0v-2h-4Z"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        <clipPath id="rdt_result_positive_svg__a">
...
const ForwardRef = forwardRef(SvgRdtResultPositive);
