...
const SvgHpv = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#hpv_svg__a)" fill={props.color}>
        ...
        />
        <path d="M31.923 27.385a1 1 0 0 1-1.846 0l-2.5-6a1 1 0 0 1 1.846-.77L31 24.4l1.577-3.785a1 1 0 0 1 1.846.77l-2.5 6Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
