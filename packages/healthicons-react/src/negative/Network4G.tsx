...
const SvgNetwork4G = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#network_4g_svg__a)" fill={props.color}>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        />
        <path d="M32.674 30.362a1 1 0 1 1-1.333 1.49 3.505 3.505 0 1 0-.334 5.487v-1.875h-2.002a1 1 0 0 1 0-2h3.002a1 1 0 0 1 1 1v3.357a1 1 0 0 1-.333.745 5.503 5.503 0 1 1 0-8.204Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
