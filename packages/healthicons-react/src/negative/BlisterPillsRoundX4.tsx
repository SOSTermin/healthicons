...
const SvgBlisterPillsRoundX4 = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#blister_pills_round_x4_svg__a)" fill={props.color}>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        />
        <path d="M22 14a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM32 14a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM22 34a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM32 34a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
      </g>
      <defs>
        <clipPath id="blister_pills_round_x4_svg__a">
